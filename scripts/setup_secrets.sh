...
echo ""
echo "Next steps:"
echo "  1. Ensure IAM role has secretsmanager:GetSecretValue permissions"
echo "  2. Deploy application with updated code"
echo "  3. Login at https://ttb-verifier.unitedentropy.com"
echo ""
